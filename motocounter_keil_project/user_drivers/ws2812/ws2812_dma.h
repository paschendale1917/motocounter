...
#define BIT_TIME																											0x0056				// 1/32000000=0,00000001562=0,03125 микросекунды длитс€ 1 тик таймера//по даташиту врем€ дл€ передачи 1 или 0 дл€ ws2812 1.25 мкс, отсюда 1,25/0,03125 =40 тиков таймера требуетс€ дл€ передачи одного бита//40==0x0028
